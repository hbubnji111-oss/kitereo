...
const SITE_CONTENT = {
  ...
  showreel: {
    ...
    // Или вставьте прямую ссылку на файл (Google Drive прямая ссылка, облако и т.д.)
    // Если заполнено — видео играет зациклено и без звука. Имеет приоритет над YouTube.
    videoFileUrl: "",

    // Вариант B — YouTube. Вставьте ссылку на видео (любой формат ссылки).
    // Если оставить "" — покажется заглушка с надписью "Скоро"
  ...
  //
  //    Вариант A — свой файл (mp4/webm). Загрузите файл в папку images/ и укажите:
  //       videoUrl: "images/project1.mp4"
  //       или прямую ссылку: "https://example.com/video.mp4"
  //       → Видео будет играть зациклено и без звука прямо на карточке.
  //
  //    Вариант B — YouTube:
